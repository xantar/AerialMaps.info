...
1)
  ...
  #  2 - DJI Inspire 1 FC350
  #  3 - DJI Phantom 3 FC300S (Phantom 3 Standard)
  #  4 - DJI Phantom 4 FC300X (Phantom 3 Advanced & Pro)
  #  5 - GoPro Hero
  #  6 - GoPro Hero3+ Black
  #  7 - GoPro Hero3-Black Edition
  #  8 - GoPro Hero3-Silver Edition
  #  9 - GoPro Hero3-White Edition
  # 10 - GoPro Hero4 Black Edition
  # 11 - GoPro Hero4 Silver Edition
  ...
  case $CAM in
    ...
    2)
	  echo '2 - DJI Inspire 1 FC350'
      rawtherapee -o $MAP -p ../RTProfiles/DJI-I1.pp3 -c ../photos/unproc/$MAP
    ;;
  
    3)
	  echo '3 - DJI Phantom 3 FC300S (Phantom 3 Standard)'
      rawtherapee -o $MAP -p ../RTProfiles/DJI-P3S.pp3 -c ../photos/unproc/$MAP
    ;;
  
    4)
	  echo '4 - DJI Phantom 4 FC300X (Phantom 3 Advanced & Pro)'
      rawtherapee -o $MAP -p ../RTProfiles/DJI-P3.pp3 -c ../photos/unproc/$MAP
    ;;
  
    5)
	  echo '5 - GoPro Hero'
      rawtherapee -o $MAP -p ../RTProfiles/GP-Hero.pp3 -c ../photos/unproc/$MAP
    ;;
  
    6)
	  echo '6 - GoPro Hero3+ Black'
      rawtherapee -o $MAP -p ../RTProfiles/GP-Hero3PB.pp3 -c ../photos/unproc/$MAP
    ;;
  
    7)
	  echo '7 - GoPro Hero3-Black Edition'
      rawtherapee -o $MAP -p ../RTProfiles/GP-Hero3B.pp3 -c ../photos/unproc/$MAP
    ;;
  
    8)
	  echo '8 - GoPro Hero3-Silver Edition'
      rawtherapee -o $MAP -p ../RTProfiles/GP-Hero3S.pp3 -c ../photos/unproc/$MAP
    ;;
  
    9)
  	  echo '9 - GoPro Hero3-White Edition'
      rawtherapee -o $MAP -p ../RTProfiles/GP-Hero3W.pp3 -c ../photos/unproc/$MAP
    ;;
  
    10)
	  echo '10 - GoPro Hero4 Black Edition'
      rawtherapee -o $MAP -p ../RTProfiles/GP-Hero4B.pp3 -c ../photos/unproc/$MAP
    ;;
  
    11)
	  echo '11 - GoPro Hero4 Silver Edition'
      rawtherapee -o $MAP -p ../RTProfiles/GP-Hero4S.pp3 -c ../photos/unproc/$MAP
    ;;
